...
>(({ className, transition, ...props }, ref) => {
  return (
    <motion.button
      ...
      ref={ref}
      className={cn(
        "group relative flex w-fit items-center rounded-full border border-[#6366f1] bg-[#6366f1]/10 px-4 py-2 shadow-[0px_4px_24px_rgba(99,102,241,0.3)] transition-colors hover:bg-[#6366f1]/20 text-white font-medium",
        className
      )}
      {...props}
    />
